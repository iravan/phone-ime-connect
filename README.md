...
**適合誰：** 使用中日韓等複雜文字的人（手機的手寫／筆劃／語音輸入遠比桌面輸入法順手）、只會手寫卻沒學過任何輸入法（拼音、注音、倉頡…）的人（手機手寫辨識讓你直接寫字，不用背輸入法）、手機重度打字者、想用語音輸入到任何程式的人、有無障礙需求者，以及重視隱私、跨生態系的人。
...
**适合谁：** 使用中日韩等复杂文字的人（手机的手写／笔画／语音输入远比桌面输入法顺手）、只会手写却没学过任何输入法（拼音、注音、仓颉…）的人（手机手写识别让你直接写字，不用背输入法）、手机重度打字者、想用语音输入到任意程序的人、有无障碍需求者，以及重视隐私、跨生态系统的人。
...
**こんな人に：** 中国語・日本語・韓国語など複雑な文字を使う人（手書き・画数・音声入力はスマホの方が断然快適）、入力方式（ローマ字・ピンイン・注音…）を覚えていないが手で書ける人（スマホの手書き認識でそのまま書ける）、スマホ入力に慣れた人、どんなアプリにも音声で入力したい人、アクセシビリティを重視する人、プライバシー重視で複数 OS を使う人。
...
**이런 분께:** 중국어·일본어·한국어 등 복잡한 문자를 쓰는 분(손글씨·획·음성 입력은 휴대폰이 훨씬 편합니다), 입력기(병음·주음·로마자…)는 몰라도 손으로 쓸 수는 있는 분(휴대폰 손글씨 인식으로 그냥 쓰면 됩니다), 휴대폰 입력에 익숙한 분, 어떤 앱에든 음성으로 입력하고 싶은 분, 접근성이 중요한 분, 프라이버시와 크로스 생태계를 중시하는 분.
